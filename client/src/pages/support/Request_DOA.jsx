  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-6">
        <Reveal>
          <div className={liftCard}>
            ...
            <p className="text-slate-600">
              DOA must be reported within <strong>7 days</strong> of billing to the
              end customer via our portal.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal className="delay-100">
          <div className={liftCard}>
            ...
            <p className="text-slate-600">
              Unit must be free from scratches, tampering, liquid damage;{" "}
              <em>gift box & warranty seal should be intact</em>.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal className="delay-200">
          <div className={liftCard}>
            ...
            <p className="text-slate-600">
              Our PM calls the customer for verification; replacement or repair
              is processed per policy.
            </p>
          </div>
        </Reveal>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 grid lg:grid-cols-2 gap-8">
          ...
          <Reveal>
            <section className={liftSection}>
              ...
              <p className="text-slate-700 mt-2">
                This includes products that you wish to report as DOA.
              </p>
              <ul className="list-disc pl-6 space-y-2 leading-relaxed text-slate-700 mt-4">
                <li>
                  DOA must be reported within <strong>7 days</strong> of billing to
                  the end customer. After 7 days, standard warranty terms apply.
                </li>
                <li>
                  DOA request should be raised via our portal after product registration; our PM
                  contacts the customer for verification/troubleshooting.
                </li>
                <li>No signs of scratches, damage, tampering, liquid damage or user defect.</li>
                <li>Gift box & Warranty Seal must be intact.</li>
                <li>
                  Problem reported must not be a software/firmware issue that can be resolved by
                  reloading or configuration.
                </li>
                <li>
                  Company obligation is limited to repairing by replacing the damaged part. If
                  the machine is beyond repair, company may opt to replace it. Claims cannot exceed
                  MRP or purchase price, whichever is lower.
                </li>
                <li>
                  If replacement is approved, unit is shipped to customer or channel partner;
                  defective unit must be handed over to AADONA authorized person.
                </li>
                <li className="italic">
                  We issue authorization with ticket number to customer; upon physical inspection,
                  if product fails checks (scratches, missing accessories), claim may be rejected.
                </li>
              </ul>
            </section>
          </Reveal>
          ...
          <Reveal>
            <section className={liftSection}>
              ...
              <ul className="list-disc pl-6 space-y-2 leading-relaxed text-slate-700 mt-3">
                ...
                <li>
                  Due to firmware upgrade/field fix, if product can be made working, only the
                  exception in return policy will apply.
                </li>
                <li>
                  Depreciation, missing accessories, scratches, or used product may reduce the refund
                  value; final decision rests with AADONA.
                </li>
        ...
        {/* Right: DOA Request Form (2-col desktop, 1-col mobile) */}
        <Reveal>
          <section className={liftSection}>
